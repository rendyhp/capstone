...
@section('container')
  ...
  <style>
    ...
    Menengahkan form di dalam border */
    }
  </style>
  <section class="vh-100">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <img src="img/draw.jpg" class="img-fluid" alt="Sample image">
      </div>
      ...
      @endif
        ...
        <input type="nama" class="form-control @error('name') is-invalid @enderror" name="name"
          value="{{ old('name') }}" style="border-radius: 20px;" placeholder="Nama" autofocus required>
      ...
      @enderror
        ...
        <div class="col-md-6">
          ...
          <input type="password" class="form-control @error('password') is-invalid @enderror" name="password"
            id="password" value="{{ old('password') }}" style="border-radius: 20px;" placeholder="Password"
      ...
      @enderror
        ...
        <div class="col-md-6">
          ...
          <input type="password" class="form-control" name="password_confirmation" id="password-confirm"
            style="border-radius: 20px;" placeholder="ConfirmPass" required autocomplete="new-password">
        ...
        <div class="">
          ...
          <div class="row mt-3">
          <div class="d-flex flex-column align-items-center">
            <label for="" class="mt-2 mb-3">Sudah punya akun? <a href="/login"
              style="font-weight: bold;">Login</a></label>
          </div>
          </div>
        </div>
        </div>
