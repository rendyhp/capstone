...
class StockOpnameController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($role === 'OWNER') {
            ...
            return view('bahan.index', ['bahans' => $bahans, ''=> $bahanAwals,''=> $historyInputs,
        ]);
        ...
        // return view('bahan.index', compact('bahans', 'bahanAwals', 'historyInputs', 'akhirTerpakaiSeharusnyas'));
    }
}
